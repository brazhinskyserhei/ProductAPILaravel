...
php artisan migrate
```
<p>После этого должна быть создана структура таблицы со всеми таблицами и данными.</p>
...
Для тестирования API можно вопользоваться люьбым HTTP-клиентом, например Postman
